...
// 1. Store the the average weight of a "Husky" in a variable "huskyWeight"
let huskyWeight = breeds.find(
  element => element.breed === 'Husky'
).averageWeight;
console.log(huskyWeight);

// 2. Find the name of the only breed that likes both "running" and "fetch" ("dogBothActivities" variable)
let dogBothActivitie = breeds.find(
  oggetto =>
    oggetto.activities.includes('running') &&
    oggetto.activities.includes('fetch')
).breed;
console.log(dogBothActivitie);
